...
export default function Header() {
  ...
  return (
    <header className="bg-white shadow">
      ...
      {/* Mobile menu — slide-over with backdrop (marketing pages only; hidden on dashboard via ClientLayout) */}
      <div
      ...
      >
        ...
        />
        <div
          className={`fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 shadow-xl transition-transform duration-300 ease-out sm:max-w-sm sm:ring-1 sm:ring-gray-900/10 ${
