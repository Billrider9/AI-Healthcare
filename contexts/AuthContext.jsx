  ...
  useEffect(() => {
    ...
    if (storedUser) {
      try {
        ...
        console.error("Invalid medira_user in localStorage", e);
      ...
      if (storedUser) {
        try {
          ...
          const sameId =
            ...
            parsedData._id === user.id ||
            parsedData.id === user._id ||
            parsedData._id === user._id;
          if (parsedData.email === user.email && sameId) {
